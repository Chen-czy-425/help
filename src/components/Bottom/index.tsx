    ...
    return (
        <>
            <div className="w-[1100px] text-center text-[#666666] pt-[37px]">
                <div>
                    <a href="https://www.ludashi.com/page/contact.php" 
                       className="text-[#666666] mx-[5px]">
                        联系我们
                    </a>|
                    <a href="https://www.sobot.com/ticketclient/index.html?sysNum=7b3d901cda854f1985677d1b773800cd&deployId=e492cf1d49d041cba51d253180a1350f&params={%22pid%22:%22home%22,%22from%22:%22officalwebsite%22}" 
                       className="text-[#666666] mx-[5px]">
                        意见反馈
                    </a>|
                    <a href="https://www.ludashi.com/link/" 
                       className="text-[#666666] mx-[5px]">
                        友情链接
                    </a>
                </div>
